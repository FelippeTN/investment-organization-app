...
class Asset(models.Model):
    ...
    pvp = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    dividend_yeld = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
